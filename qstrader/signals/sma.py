...
class SMASignal(Signal):
    """
    Indicator class to calculate simple moving average of last N periods for a set of prices.
    """
    ...
    def _simple_moving_average(self, asset: str, lookback: int) -> float:
        """
        Calculate the 'trend' for the provided lookback period based on the simple moving average of the price buffers

...
# example: uv run python scripts/static_backtest.py --start-date 2015-01-01 --end-date 2026-07-31 --allocations "SPY:0.4,TLT:0.3,GLD:0.3" --title "3-Asset Asset Allocation (SPY/TLT/GLD: 40/30/30) vs. Benchmark (SPY/AGG: 60/40)" --id "three-asset" --tearsheet
